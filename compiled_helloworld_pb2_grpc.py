...
import compiled_helloworld_pb2 as compiled__helloworld__pb2
...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                request_serializer=compiled__helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=compiled__helloworld__pb2.HelloReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=compiled__helloworld__pb2.HelloRequest.FromString,
                    response_serializer=compiled__helloworld__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/helloworld.Greeter/SayHello',
            compiled__helloworld__pb2.HelloRequest.SerializeToString,
            compiled__helloworld__pb2.HelloReply.FromString,
